...
%\footnote{More specifically, it ``takes a number and returns an atomic set of individuals whose cardinality equals that number'' \cite[sec. 5.1, cf. ex. 41]{wagiel2017several}.} 
