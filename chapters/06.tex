...
In Wolof, nominal modifiers usually have the syntax of relative clauses (e.g. \textit{tall} in \ref{fon:kOzARiVv6}). Expressions for nationality, however, occur as plain modifiers (i.e., without the syntax of a relative clause.)
    ...
    \begin{exe}
    \judgewidth{??}
        \ex[*]{\gll	Roxaya dajeele-na {f\'{e}cckat} \dashuline{brezilien}.\\
				Roxaya gather-\textsc{na.3sg} dancer Brazilian\\
				\glt Intended: `Roxaya gathered Brazilian student.'}\label{fon:pLEjNBrZl}
		\ex[]{ \gll Gis na-a {woykat} \dashuline{brezilien}. Maymuna b\"{e}gg na ko / \minsp{*} leen.\\
		...
		\ex[*]{\gll	J\`{a}ngalekat b-i desin-ante-loo-na {ndonggo darra} \dashuline{brezilien}.\\
	...
	\ex[??]{\gll   J\`{a}ngalekat b-i nataal-oo-na {ndonggo darra} \dashuline{angale} seen bopp.\\
...
As a byproduct of the projection of \textit{n}P, a plural Num can also be introduced in the derivation, as its lowering requirement can now be fulfilled.	
