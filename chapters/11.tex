...
\ex \label{sch-has:ex:7a} \textsc{scenario:} Abe read books 1 and 2. Bert read book 3. \hfill \REF{sch-has:ex:6a} \textsc{true} 
\z\z
...
\ex \label{sch-has:ex:9} \textsc{scenario:} Last weekend, Abe and Bert stayed at Roy's castle. They both wrongly believe the castle is haunted by ghosts. At night, Abe went out to look for the ghost of its previous owner, who died in 1980. Bert looked for the ghost of its first owner, who died in 1400.\\\null\hfill \REF{sch-has:ex:10} \textsc{true}
\ex \label{sch-has:ex:11} \textsc{scenario:} (Roy's castle, no ghosts\ldots) At night, Abe went outside and tried to find some ghost of a previous owner of the castle (he doesn't care which one). Bert also went out to look for some ghost of a previous owner. \hfill \REF{sch-has:ex:10} \textsc{not true}
\z\z
...
\ex \label{sch-has:ex:15} \textsc{scenario:} (Roy's castle, no ghosts\ldots) At night, Abe went outside to look for the ghost of the previous owner, who died in 1980. Independently, Bert (who Abe has never met) also went outside to look for the ghost of the previous owner\ldots \hfill \REF{sch-has:ex:14} \textsc{true}
\z\z
...
\ex \label{sch-has:ex:25} \textsc{scenario:} The Paris agency believes Macron might resign. The Berlin agency believes  Merkel is becoming paranoid.  \hfill \REF{sch-has:ex:24} \textsc{true}\z\z
